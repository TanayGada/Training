...
// In 1 traversal from left to right, we can only collect consecutively numbers starting from the minimum element
// if the smallest element is x, but x+1 is already seen before x, then the current traversal ends there
// we need to do another traversal
