...
// we need to check net how many customers are present at a time
// a customer we always leave after it have arrived
// the order of which customer arrived/left doesnot matter
void solve()
{
    // Add your code here
    int n; cin>>n;
    ...
    for(int ptr1 = 0, ptr2 = 0; ptr1<n;){
        if(arr[ptr1]<dept[ptr2]){
            ptr1++;
            ans++;
        }
        else{
