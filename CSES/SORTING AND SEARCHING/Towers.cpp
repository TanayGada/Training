...
// greedy
// we store new elements in a set
// then remove all the elements larger than the current element
// removing a element in 1 operation, makes sure there is no more than 1 element greater than i
